USE [DOM_LIVE]
GO
/****** Object:  StoredProcedure [dbo].[usp_Sync_ClientDiary_Initial]    Script Date: 20/07/2026 09:53:00 ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO dbo.tbl_ClientDiary (
    ...
    Client_Diary_Entry_Text, Client_Diary_Review_Date, Client_Diary_Action,
    Client_Diary_Action_Date, Client_Diary_Done_Date, Client_Diary_Reminded,
...
SELECT 
    ...
    CASE WHEN CDY.ACTION = ''Y'' THEN 1 ELSE 0 END AS Client_Diary_Action,
    CDY.ACTIONDT                          AS Client_Diary_Action_Date,
    CDY.REVDONE_DT                        AS Client_Diary_Done_Date,
    CASE WHEN CDY.REMINDED = ''Y'' THEN 1 ELSE 0 END AS Client_Diary_Reminded,
