...
BEGIN
    ...
    BEGIN
        SELECT N'Initial' AS Stage, CAST(N'Clients initial failed: could not acquire applock.' AS nvarchar(4000)) AS Summary;
        RETURN -1;
    END;
    ...
    BEGIN TRY
        ...
        IF OBJECT_ID(N'dbo.usp_Sync_Clients_Incremental', N'P') IS NOT NULL
        BEGIN
            DECLARE @rc int;
        ...
        SELECT N'Initial'     AS Stage, @InitialMsg AS Summary
        UNION ALL
        SELECT N'Incremental' AS Stage, @IncrMsg    AS Summary;
    ...
    BEGIN CATCH
        ...
        SELECT N'Initial' AS Stage, CAST(CONCAT(N'Clients initial failed: ', @msg) AS nvarchar(4000)) AS Summary;
